            ...
            {sites.map(site => {
              ...
              return (
                <TabsTrigger
                  key={site.id}
                  value={site.id}
                  className="justify-start gap-3 px-4 py-2.5 text-sm font-medium transition-all hover:bg-muted/50 data-[state=active]:bg-primary/10 data-[state=active]:text-primary"
                >
